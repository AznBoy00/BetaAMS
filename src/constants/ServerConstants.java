...
public class ServerConstants {
    ...
    public static String TIMEZONE = "-GMT5";
    ...
    //Server Flags
    public static final boolean USE_CUSTOM_KEYSET = true;           //Enables auto-setup of the custom keybindings when creating characters.
